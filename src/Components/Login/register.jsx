...
class Register extends React.Component {
  ...
  HandleClickRegister() {
    Swal.fire({
      icon: 'success',
      type: "success",
      title: '<strong><h2 class="font-36 proxima-bold mt-3 mb-3">Registrasi Berhasil!</h2></strong>',
      html: '<div class="container"><h6 class="font-24 proxima-bold">Cek email Anda Untuk melakukan aktifasi.</h6> <br> <p class="font-16 color-bb proxima-reguler">Pendaftaran member menunggu aktifasi. Cek email Anda.</p></div>',
